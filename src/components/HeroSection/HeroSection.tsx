  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center px-4">
        <div className="backdrop-blur-sm  p-6 rounded-md">
          <div className="relative mx-auto max-w-4xl text-center w-full">
            ...
            >
              At the OCC, we create unforgettable events by combining
              exceptional food, flawless service, and genuine hospitality.
            </motion.p>
