...
const Insta = () => {
    return (
        <div className="mx-auto max-w-2xl pb-16 lg:max-w-7xl bg-card-background text-text-primary rounded-lg shadow-md p-4">
            <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                ...
                <div className="mx-auto imageContainer">
                    ...
                    <Link href={"https://instagram.com"} target="_blank">
                        <button
                            className="hidden text-elements-primary-contrastText font-semibold absolute z-10"
                            style={{
                                top: "45%",
                                right: "45%",
                            }}
