      ...
      <div className="container mx-auto px-6 lg:px-8 relative">
        ...
        >
          ...
          <div className="text-center max-w-4xl mx-auto">
            <SectionHeader
              badge={aboutStory.header.badge}
              title={aboutStory.header.title}
              subtitle={aboutStory.header.subtitle}
              description={aboutStory.header.description}
              alignment="center"
              maxWidth="3xl"
              showDecorator={true}
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-7 space-y-16">
              <div className="space-y-12">
                {/* Timeline Item */}
                {aboutStory.timeline.map(({ date, text, color }, i) => (
                  <motion.div
                    key={i}
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  <p className="text-sm font-semibold mb-1">
                    {aboutStory.image.captionTitle}
                  </p>
                  <p className="text-xs opacity-80">
                    {aboutStory.image.captionSubtitle}
                  </p>
                </div>
              </motion.div>
                ...
                <div className="flex items-center space-x-4 mt-4">
                  ...
                  <div>
                    <p className="text-base font-medium text-text-primary">
                      {aboutStory.quoteAuthor.name}
                    </p>
                    <p className="text-sm text-text-tertiary">
                      {aboutStory.quoteAuthor.role}
                    </p>
                  </div>
                </div>
              </motion.div>
